...
subjectHash = open("data\\yesSubjectHash.csv", mode='r', encoding='utf-8')
placeHash = open("data\\yesPlaceHash.csv", mode='r', encoding='utf-8')
...
with open("data\\" + yesorno + ".json", mode='r') as inputs:
    with open("data\\" + yesorno + ".csv", mode='w', encoding='utf-8', newline='') as output:
